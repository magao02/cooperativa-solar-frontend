...
const columns = [
  ...
  {
    key: "potencialInstalada",
    label: "Potência Instalada (kwp)",
  },
  {
    key: "potencialNominal",
...
const INITIAL_VISIBLE_COLUMNS = ["nome", "estado", "potencialInstalada","numeroClientes", "capacidadeClientes", "capacidadeGeracao","actions"];
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              >
                {(item) => <AutocompleteItem key={item.id}>{item.nome}</AutocompleteItem>}
              </Autocomplete>
